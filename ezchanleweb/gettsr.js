...
mongoose.connect("mongodb://localhost:27017/thaiDbz", { useUnifiedTopology: true, useNewUrlParser: true, useFindAndModify: false, useCreateIndex: true }, () => console.log('Connected to db'));
...
auto = async () => {
    try {
        ...
        if (cookies == null) {
            ...
            await page.type("#phoneOrEmail", 'thuc22');
            await page.type("#password", 'thuc6633');
